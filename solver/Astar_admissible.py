                ...
                if cell not in tuple(self.tgt_positions) and self.obstacle_map[y][x] is not self.OBSTACLE_SYMBOL:
                    ...
                    if len(adjacent_walls) >= 3 or (
                            ...
                            adjacent_walls[0][
                                ...
                                cell[1]] is not self.OBSTACLE_SYMBOL):
                ...
                for b in range(a, len(corners)):
                    ...
                    if cell1 != cell2 and cell1[i] == cell2[i]:
                        ...
                        for d in range(1, length):
                            ...
                            if checked in self.tgt_positions or checked in self.box_positions or \
                                    self.obstacle_map[checked[0]][checked[1]] \
    ...
    def astar(self):
        ...
        while len(container) > 0:
            ...
            for s in suc:
                ...
                new_state2 = (tuple(new_positions[0]), tuple(new_positions[1]))  # Don't need to add tgt positions
                # print('the new state', new_state)
                if new_state2 not in visited and any(e in new_state[1] for e in dead_locks) is False:
